...
OUTPUT_DIR = "CurrentModel/outputs"
os.makedirs(OUTPUT_DIR, exist_ok=True)

TARGETS = ["CURRENT_RISK"]
...
print("\n" + "=" * 70)
print("CURRENT RISK PROBABILITY CALIBRATION")
print("=" * 70)
...
for target in TARGETS:
    model_path = os.path.join(MODEL_DIR, "xgb_current_risk.pkl")
    ...
    print(f"Brier improvement : {brier_change:.4f}")
    print(f"Log-loss improvement : {logloss_change:.4f}")

    joblib.dump(calibrator, f"{OUTPUT_DIR}/current_risk_calibrator.pkl")
...
prediction_path = f"{OUTPUT_DIR}/calibrated_predictions.csv"
...
print("\n" + "=" * 70)
print("CURRENT MODEL CALIBRATION COMPLETE")
print("=" * 70)
